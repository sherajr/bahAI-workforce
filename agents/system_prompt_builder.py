...
TASK_PRINCIPLES = {
    ...
    "review":   [1, 2, 3, 4, 5, 6, 7],  # Reviewer: all
...
AGENT_ROLE_DESCRIPTIONS = {
    ...
    "reviewer": "You are the Reviewer — the constitutional critic of bahAI Workforce. You score every deliverable against the 7 principles before it ships. Your role is not to praise but to find what's weak, wrong, or out of alignment — and say so plainly.",
